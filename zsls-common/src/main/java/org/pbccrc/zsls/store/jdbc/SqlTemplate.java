...
public interface SqlTemplate {
    ...
    void createSequence(final String sql) throws SQLException;
    ...
    int insert(final String sql, Transaction trans, final Object... params) throws SQLException;

    int update(final String sql, final Object... params) throws SQLException;
    
    int update(final String sql, Transaction trans, final Object... params) throws SQLException;

    int delete(final String sql, final Object... params) throws SQLException;
    
    int delete(final String sql, Transaction trans, final Object... params) throws SQLException;

    <T> T query(final String sql, final ResultSetHandler<T> rsh, final Object... params) throws SQLException;
    
    <T> T query(final String sql, Transaction trans, final ResultSetHandler<T> rsh, final Object... params) throws SQLException;
