...
public class NumberUtils {
	...
	static class Md5 {
	    ...
	    public String processString () {
			try {
			    ...
			    return NumberUtils.encodeHex(bytes);
	...
	public static String signMD5(InputStream in) {
		try{
		    Md5 md5 = new Md5(in);
		    return md5.processString();
		} catch(Exception e) {
			return null;
		}
    }

    public static byte[] signMD5(byte[] bytes) {
		try{
