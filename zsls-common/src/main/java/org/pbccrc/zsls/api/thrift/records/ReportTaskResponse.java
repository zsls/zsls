            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.newTasks = new ArrayList<TTaskInfo>(_list52.size);
                TTaskInfo _elem53;
                for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                {
                  _elem53 = new TTaskInfo();
                  _elem53.read(iprot);
                  struct.newTasks.add(_elem53);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.newTasks != null) {
        if (struct.isSetNewTasks()) {
          oprot.writeFieldBegin(NEW_TASKS_FIELD_DESC);
          {
            ...
            for (TTaskInfo _iter55 : struct.newTasks)
            {
              _iter55.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetNewTasks()) {
        {
          ...
          for (TTaskInfo _iter56 : struct.newTasks)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.newTasks = new ArrayList<TTaskInfo>(_list57.size);
          TTaskInfo _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = new TTaskInfo();
            _elem58.read(iprot);
            struct.newTasks.add(_elem58);
          }
        }
        struct.setNewTasksIsSet(true);
      }
